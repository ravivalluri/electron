...
[IPC](../glossary.md#ipc) when called from the renderer process. The cached value is reread from the
...
synchronous [IPC](../glossary.md#ipc) when called from the renderer process.
